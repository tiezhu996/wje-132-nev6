...
const (
	...
	LogIncidentReviewSuccess      = "incident rectification review success"
	LogIncidentReviewRejected     = "incident rectification review rejected"
	LogIncidentReviewFailed       = "incident rectification review failed"
